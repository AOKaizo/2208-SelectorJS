...
class $ {
  constructor(CSSId) {
    ...
    if (CSSId.includes('.')) {
        let preppedTag = document.getElementsByTagName(CSSId.slice(0, CSSId.indexOf('.')));
        storedTag = [...preppedTag].filter((element) => element.includes(CSSId.slice(CSSId.findIndex(element => element === '.')+1)))
